...
export function Modal({
  ...
  return (
    ...
    >
      ...
      <div className="relative max-h-[88dvh] w-full max-w-md overflow-y-auto rounded-t-2xl border-t-[3px] border-line bg-screen px-4 pt-2 pb-10 shadow-2xl sm:max-h-[85dvh] sm:rounded-2xl sm:border-[3px] sm:pb-6">
